...
describe('questionnaire data access layer', () => {
    ...
    describe('getTemplateMetadataByOwner', () => {
        const query = `SELECT id, questionnaire -> 'meta' AS "meta", questionnaire -> 'answers' -> 'system' ->> 'case-reference' AS "caseReference", questionnaire -> 'answers' -> 'owner' AS "owner" FROM questionnaire WHERE questionnaire -> 'answers' -> 'owner' ->> 'owner-id' = $1`;
